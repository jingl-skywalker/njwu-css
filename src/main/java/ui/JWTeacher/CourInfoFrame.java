 ...
 * @author zili chen
 */
public class CourInfoFrame extends javax.swing.JFrame {
String depart;
CourseBLService courseBL;
    /**
     * Creates new form PlanInfoFrame
     */
    public CourInfoFrame(CourseBLService courseBL,String term) {
    ...
    private void sureButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sureButtonActionPerformed
        ...
        CourseVO course = new  CourseVO(idTextField.getText(),nameTextField.getText(),(String)moduleComboBox.getSelectedItem(),
                ...
                teaNameTextField.getText(),teaIDTextField.getText(),timeTextField.getText(),(String)insOpenComboBox.getSelectedItem(),
                "All",peopleNumTextField.getText(),"课程大纲","教才","参考文献") ;
        //pvo = new PlanVO(institute,term,module,property,type,courseID,courseName+"",credit+"",hour+"","");
        ResultMessage r;
        if((r=courseBL.jcreateCourse(course))==ResultMessage.SUCCESS){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CourInfoFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CourInfoFrame(null,"").setVisible(true);
            }
        });
    }
